...
function ensureErrorType(err) {
    ...
    if (err instanceof Error) {
        const writable = (_a = Object.getOwnPropertyDescriptor(err, 'message')) === null || _a === void 0 ? void 0 : _a.writable;
        if (!writable) {
...
class HttpRequest {
    constructor(init) {
        ...
        __classPrivateFieldSet(this, _HttpRequest_uReq, uReq, "f");
        if (init.nullableQuery || init.query) {
            ...
            this.query = new URL(__classPrivateFieldGet(this, _HttpRequest_uReq, "f").url).searchParams;
        }
...
function createStreamRequest(proxyReq, triggerMetadata) {
    ...
    const uReq = new undici_1.Request(url, {
        body,
        duplex: 'half',
    ...
    for (const [key, rpcValue] of Object.entries(rpcParams)) {
        const value = (0, fromRpcTypedData_1.fromRpcTypedData)(rpcValue);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.setupHttpProxy = exports.sendProxyResponse = exports.waitForProxyRequest = void 0;
...
function sendProxyResponse(invocationId, userRes) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (userRes.body) {
            try {
                for (var _b = __asyncValues(userRes.body.values()), _c; _c = yield _b.next(), !_c.done;) {
...
// Licensed under the MIT License.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.generic = exports.sql = exports.warmup = exports.cosmosDB = exports.eventGrid = exports.eventHub = exports.serviceBusTopic = exports.serviceBusQueue = exports.storageQueue = exports.storageBlob = exports.timer = exports.http = void 0;
const addBindingName_1 = __webpack_require__(/*! ./addBindingName */ "./src/addBindingName.ts");
function http(options) {
